      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div>
          ...
          <input
            ...
            } bg-white px-3 py-1.5 text-sm shadow-sm focus:border-zinc-500 focus:ring-zinc-500 focus:outline-none dark:bg-zinc-900 dark:text-zinc-100`}
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            } shadow-sm focus:ring-2 focus:ring-zinc-500 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50`}
          >
            {status === 'loading' ? 'Sending...' : 'Send'}
            {status !== 'loading' && (
              <SendIcon className="ml-1.5 h-3.5 w-3.5" />
            )}
          </button>
